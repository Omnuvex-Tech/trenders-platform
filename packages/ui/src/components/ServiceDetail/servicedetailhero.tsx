...
/**
 * Hər element özü ekrana girəndə (yaxud bfcache-dən persisted
 * pageshow zamanı) "visible" olur. Hər çağırış öz ref/observer-inə malikdir,
 * ona görə scroll etdikcə hər blok öz növbəsində animasiya olunur.
 */
