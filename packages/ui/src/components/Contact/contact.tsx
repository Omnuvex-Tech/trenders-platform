...
//                     {value || placeholder}
//                 </span>
//                 <svg className={`${styles.customSelectArrow} ${isOpen ? styles.customSelectArrowOpen : ""}`}
...
//                                 onClick={() => { setForm((prev: any) => ({ ...prev, [name]: o })); setOpenDropdown(null); }}>
//                                 {o}
//                             </div>
//                         ))}
//                     </div>
...
//         if (form.phone && digitCount < 6) { setError("Telefon nömrəsi ən azı 6 rəqəm olmalıdır."); return; }
//         setSubmitting(true); setError("");
//         try {
//             await onSubmit(form);
//             setSubmitted(true);
//             setForm({ name: "", email: "", phone: "", service: "", budget: "", timeline: "", message: "" });
//         } catch { setError("Göndərilmədi, yenidən cəhd edin."); }
...
//                                 <span data-reveal className={styles.revealInner}>{word}&nbsp;</span>
//                             </span>
//                         ))}
//                     </h2>
...
//                                     {link.icon && <img src={link.icon} alt="" width={16} height={16} style={{ objectFit: "contain" }} />}
//                                 </a>
//                             ))}
//                         </div>
//                     </div>
...
//                                     openDropdown={openDropdown} setOpenDropdown={setOpenDropdown} setForm={setForm} />
//                             </div>
//                         </div>
