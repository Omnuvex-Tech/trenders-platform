...
// TS hover tip xətasını aradan qaldıran variant
            ...
            <div className={styles.inner}>
                <div className={styles.card}>
                    ...
                    >
                        ...
                        <Link href={href} className={styles.titleLink}>
                            {/* TypeScript xətasını önləyən element artıq dangerouslySetInnerHTML-in xaricindədir */}
