...
// XƏTANI ÖNLƏYƏN ANIMASIYA VARIANTLARI
...
// Hover zamanı baş verən hərəkətin etibarlı tip variantı
                        ...
                        {filtered.length === 0 ? (
                            ...
                            filtered.map((post, i) => (
                                <motion.div
                                    ...
                                    whileHover="hover"
                                >
                                    {/* Hover xətasını önləyən alt variant bura qeydiyyatdan keçir */}
