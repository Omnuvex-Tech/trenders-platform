# trenders-platform Project Terms
...
Application-specific classes (e.g., `ApiResponse`) live in `apps/trenders-web/classes/`, not in shared packages. Only truly shared utilities belong in `packages/shared`.
